...
def construir_workbook(df_norm: pd.DataFrame, resumen: pd.DataFrame,
    ...
    diccionario = [
        ...
        ("Precio Tarjeta (S/)",   "Número", "Precio pagando con la tarjeta del supermercado. Tottus: exacto (del CMR). Plaza Vea: calculado como Precio Internet menos el descuento de la promoción Oh!, que VTEX expresa en soles sobre la unidad de venta. Wong y Metro: no aplica."),
        ...
        ("Precio Internet (S/)",  "Número", "Precio web sin tarjeta. Es el precio que paga el cliente sin promoción. En productos por peso, es por kilo."),
        ("Precio Unidad (S/)",    "Número", "Precio del artículo entero (FullSellingPrice de VTEX). En un pollo de 2,2 kg a S/ 8,90/kg es 19,58. Es la base sobre la que Plaza Vea expresa los descuentos de la Tarjeta Oh!. Solo VTEX."),
